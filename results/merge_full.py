...
root_ori = '/ssd/1/yrz/Dataset/GoPro_INR/GoPro_test_sharp_resized_cropped/'   # gt root of testing dataset
test_frame = 15                        # test frame in your testing yaml(e.g. line 17 of test_Deblur_GOPRO.yml)
